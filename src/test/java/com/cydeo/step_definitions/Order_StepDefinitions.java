...
public class Order_StepDefinitions {
    ...
    public void user_enters_quantity(Integer int1) {
        ...
        // sendKeys oly accept string. if we want int; both we can concat or we can use upper method
...
orderPage.creditCardType(string).click();
    ...
    public void user_should_see_in_first_row_of_the_web_table(String string) {
        ...
        Assert.assertEquals(string,orderPage.firstLineName.getText());
